...
class MotionPrediction(nn.Module):
    def __init__(self, seq_len = 256, forecast_num = 1):
        ...
        self.conv1 = nn.Conv2d(513, 512, kernel_size=3, stride=1, padding=1)
...
class STPN_MotionNet(nn.Module):
    def __init__(self, height_feat_size=256, forecast_num=3):
        ...
        self.conv_pre_1 = nn.Conv2d(height_feat_size, 512, kernel_size=3, stride=1, padding=1)
        self.conv_pre_2 = nn.Conv2d(512, 512, kernel_size=3, stride=1, padding=1)
        self.bn_pre_1 = nn.BatchNorm2d(512)
        self.bn_pre_2 = nn.BatchNorm2d(512)

        self.conv3d_1 = Conv3D(1024, 1024, kernel_size=(forecast_num, 1, 1), stride=1, padding=(0, 0, 0))
        self.conv3d_2 = Conv3D(2048, 2048, kernel_size=(1, 1, 1), stride=1, padding=(0, 0, 0))
        # self.conv3d_1 = Conv3D(64, 64, kernel_size=(1, 1, 1), stride=1, padding=(0, 0, 0))
        # self.conv3d_2 = Conv3D(128, 128, kernel_size=(1, 1, 1), stride=1, padding=(0, 0, 0))

        self.conv1_1 = nn.Conv2d(512, 1024, kernel_size=3, stride=2, padding=1)
        self.conv1_2 = nn.Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1)

        self.conv2_1 = nn.Conv2d(1024, 2048, kernel_size=3, stride=2, padding=1)
        self.conv2_2 = nn.Conv2d(2048, 2048, kernel_size=3, stride=1, padding=1)
        ...
        self.conv7_1 = nn.Conv2d(2048 + 1024, 1024, kernel_size=3, stride=1, padding=1)
        self.conv7_2 = nn.Conv2d(1024, 1024, kernel_size=3, stride=1, padding=1)

        self.conv8_1 = nn.Conv2d(1024 + 512, 512, kernel_size=3, stride=1, padding=1)
        self.conv8_2 = nn.Conv2d(512, 512, kernel_size=3, stride=1, padding=1)

        self.bn1_1 = nn.BatchNorm2d(1024)
        self.bn1_2 = nn.BatchNorm2d(1024)

        self.bn2_1 = nn.BatchNorm2d(2048)
        self.bn2_2 = nn.BatchNorm2d(2048)
