...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--root', default='/GPFS/data/slren/complete/', type=str, help='Root path to nuScenes dataset')
    ...
    parser.add_argument('-p', '--savepath', default='/GPFS/data/zxlei/dataset/test1/', type=str, help='Directory for saving the generated data')
    parser.add_argument('-a', '--agent', default=[0,1,2,3,4], nargs='+', type=int, help='agent num')
    ...
    for current_agent in args.agent:
