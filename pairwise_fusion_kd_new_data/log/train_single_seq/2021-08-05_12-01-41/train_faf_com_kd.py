...
def main(config, config_global, args):
    ...
    if args.mode == 'train':
        ...
        example_dict = {}
        example_dict['padded_voxel_points'] = padded_voxel_points_example
        example_dict['label_one_hot'] = label_one_hot_example
        example_dict['reg_target'] = reg_target_example
        example_dict['reg_loss_mask'] = reg_loss_mask_example
        example_dict['anchors_map'] = anchors_map_example
        example_dict['motion_one_hot'] = motion_one_hot_example
        example_dict['motion_mask'] = motion_mask_example
        example_dict['vis_maps'] = vis_maps_example
        ...
        for epoch in range(start_epoch, num_epochs + 1):
            ...
            for sample0, sample1, sample2, sample3, sample4 in tqdm(zip(trainloader0, trainloader1, trainloader2, trainloader3, trainloader4)):
                ...
                if config.KD:
                    ...
                    loss, cls_loss, loc_loss = fafmodule.step(data, batch_size, example_dict, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--agent_num', default=5, type=int, help='num of agent')
